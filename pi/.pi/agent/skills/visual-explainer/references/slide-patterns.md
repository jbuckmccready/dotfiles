...
**Step 4 — Verify before writing HTML.** Scan the inventory from Step 1. Is anything unmapped? Would a reader of the source document notice something missing from the deck? If yes, add slides. A source document with 7 sections typically produces 18–25 slides, not 10–13.
...
function autoFit() {
    ...
    document
        .querySelectorAll(".slide--quote blockquote")
        .forEach(function (el) {
...
<section class="slide slide--diagram">
    ...
    <div class="mermaid-wrap reveal" style="flex:1; min-height:0;">
        <div class="zoom-controls">
            ...
            <button onclick="zoomDiagram(this,0.8)" title="Zoom out">
                &minus;
            </button>
