...
Each subagent runs in an **isolated process** and inherits the caller's current working directory.
...
`,
  ...
  if (canDelegate) {
    pi.registerTool({
      ...
      label: "Subagent",
      description: [
        "Delegate work to specialized subagents running in isolated pi processes that inherit the caller's current working directory.",
        "",
