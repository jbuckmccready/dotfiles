 ...
 * https://github.com/mitsuhiko/agent-stuff/blob/9982a68947bfa4d1c09d7dcea0cf126dbc005620/pi-extensions/prompt-editor.ts
 *
 * Modified:
 * - Fixed TypeScript type errors
 *
 * Adds mode-aware prompt editing with model + thinking-level presets,
 * per-project and global mode persistence, and a custom editor UI.
 */
